  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-orange-100 selection:text-orange-900 relative overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            {[
              ...
              <div key={idx} className="p-6 md:p-10 rounded-2xl border border-gray-200 hover:border-orange-300 hover:shadow-xl transition-all duration-300 bg-white group">
                ...
                <p className="text-slate-600 leading-relaxed text-base md:text-lg font-medium">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto space-y-10">
            <Card className="border border-gray-200 shadow-xl bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-500">
              ...
              <CardContent className="p-6 md:p-12">
                <form onSubmit={(e) => handleSubmit(e)} className="space-y-6 md:space-y-8">
            ...
            {currentAnswer && (
              <Card id="answer-panel" className="border border-gray-200 shadow-lg bg-white rounded-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 ring-1 ring-black/5">
                <CardHeader className="bg-gray-50 border-b border-gray-200 py-4 md:py-6 px-6 md:px-10 flex flex-row justify-between items-center">
                  ...
                  >
                      {isCopied ? <Check className="h-4 w-4 mr-1.5 md:mr-2" /> : <Copy className="h-4 w-4 mr-1.5 md:mr-2" />}
                      {isCopied ? 'Saved' : 'Copy'}
                  </Button>
                </CardHeader>
      ...
      <section id="team" className="py-16 md:py-32 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-4xl md:text-6xl font-extrabold text-gray-900 tracking-tight mb-4">Engineering Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {TEAM_MEMBERS.map((member) => (
              <div key={member.name} className="group bg-white p-8 md:p-10 rounded-2xl border border-gray-200 hover:border-orange-300 hover:shadow-2xl transition-all duration-300 text-center relative overflow-hidden flex flex-col items-center">
                ...
                <div className="mt-2">
                    <h3 className="font-bold text-gray-900 text-xl md:text-2xl mb-2 tracking-tight">{member.name}</h3>
                    <p className="text-orange-600 text-xs md:text-sm uppercase tracking-widest font-bold mb-6">{member.role}</p>
                </div>
